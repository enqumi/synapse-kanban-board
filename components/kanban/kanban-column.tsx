...
export function KanbanColumn({ status, tasks, onAddTask, onDeleteTask, onStatusChange }: KanbanColumnProps) {
  ...
  // --- ИСПРАВЛЕНИЕ ТУТ ---
  // Проверяем, есть ли такой статус в конфиге. 
  // Если нет (например, пришло "todo", а в конфиге "planned"), берем дефолт или маппим вручную.
  ...
  return (
    ...
    >
      <div className="mb-4 flex items-center justify-between px-1">
        ...
        {/* ... остальной код кнопки и ScrollArea */}
        <button
          type="button"
          onClick={onAddTask} 
